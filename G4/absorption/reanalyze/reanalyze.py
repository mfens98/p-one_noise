...
try:
	if a[1]==6:
		print("Writing out!")
		ival = str(infile).split('/')[-1].split('.')[0]
		print(ival)
		ival = int(ival)
		pid = (ival-(ival%7767))/7767
		c.write_data(all_coincs,'/data/p-one/mens/G4/absorption/reanalyze/cedarCoincidences/','all'+str(pid)+'.txt',append=True)
	else:
